...
model.add(Dense(hidden_units, activation = 'relu', input_shape=(num_pixels,)))

model.add(Dense(num_classes, activation = 'softmax', input_shape=(hidden_units,)))
...
#plt.show()
plt.savefig("acc_3_3 {0}.png".format(hidden_units))
...
#plt.show()
plt.savefig("ldf_3_3 {0}.png".format(hidden_units))
